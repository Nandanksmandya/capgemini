...
class Fbtheme:
    ...
    def click_on_change_theme(self):
        locator = self.lo["change_theme"]
        self.driver.find_element(*locator).click()

    def click_on_theme(self, theme):
        locator_name, locator_value = self.lo["select_theme"]
        self.driver.find_element(locator_name, locator_value.format(theme)).click()
        locator1 = self.lo["save"]
        self.driver.find_element(*locator1).click()
